...
<div class="container px-6 mx-auto grid">
    ...
    {{-- <div class="w-full ">
            <button id="createProductButton" data-modal-toggle="createProductModal"
                class="flex items-center justify-between px-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-lg active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple">
                <div class=" mr-2 -ml-1" fill="currentColor" aria-hidden="true"
                    viewBox="0 0 20 20">
            ...
            <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                ...
                <div class="flex flex-col md:flex-row items-stretch md:items-center md:space-x-3 space-y-3 md:space-y-0 justify-between mx-4 py-4 border-t dark:border-gray-700">
                    ...
                    <div class="w-full md:w-auto flex flex-col md:flex-row space-y-2 md:space-y-0 items-stretch md:items-center justify-end md:space-x-3 flex-shrink-0">
                        ...
                        <button id="createProductButton" data-modal-toggle="createProductModal"
                            class="flex items-center justify-between px-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-lg active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple">
                            <div class=" mr-2 -ml-1" fill="currentColor" aria-hidden="true" viewBox="0 0 20 20">
                                <i class="fa-solid fa-square-plus"></i>
                            </div>
                            <span>Add Product</span>
                        </button>
                            ...
                            <tr class="border-b dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700">
                                ...
                                <th scope="row"
                                    ...
                                    <div class="flex items-center mr-3">
                                        <img src="{{ asset('images/' . $product->product_image) }}" class="h-8 w-auto mr-3">
                                    </div>
                                </th>
                                ...
                                <td class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                    <div class="flex items-center space-x-4">
                                        ...
                                        <button type="button" data-drawer-target="drawer-read-product-advanced-{{ $product->id }}"
    ...
    <div id="createProductModal" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative p-4 w-full max-w-3xl h-full md:h-auto">
            ...
            <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                ...
                <!-- FORM Modal body -->
                <form action="{{ route('add-product-admin') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="grid gap-4 mb-4 sm:grid-cols-2">
                        ...
                        <div><label for="category" name="category"
                        ...
                        <div>
                            <label for="brand" name="stock"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Stock</label>
                            <input type="number" name="stock" id="brand"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                placeholder="Product brand" required="">
                        </div>
                        <div>
                            <label for="price" name="category"
    ...
    @foreach($products as $product)
    <form action="{{ route('update-product-admin', $product->id) }}" method="POST" enctype="multipart/form-data" id="drawer-update-product-{{ $product->id }}" class="fixed top-0 left-0 z-40 w-full h-screen max-w-3xl p-4 overflow-y-auto transition-transform -translate-x-full bg-white dark:bg-gray-800" tabindex="-1" aria-labelledby="drawer-update-product-label" aria-hidden="true">
        @csrf
        @method('PUT')

        <h5 id="drawer-label-{{ $product->id }}" class="inline-flex items-center mb-6 text-sm font-semibold text-gray-500 uppercase dark:text-gray-400">
            Newa Product
        </h5>
        <button type="button" data-drawer-dismiss="drawer-update-product-{{ $product->id }}" aria-controls="drawer-update-product-{{ $product->id }}" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 absolute top-2.5 right-2.5 inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white">
        ...
        <div class="grid gap-4 sm:grid-cols-3 sm:gap-6 ">
            <div class="space-y-4 sm:col-span-2 sm:space-y-6">
                ...
                <div>
                    ...
                    <div class="w-full border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600">
                        <div class="px-4 py-3 bg-white rounded-b-lg dark:bg-gray-800">
                            <textarea id="description" name="description" rows="8" class="w-full px-0 text-sm text-gray-800 bg-white border-0 dark:bg-gray-800 focus:ring-0 dark:text-white dark:placeholder-gray-400">{{ $product->product_description }}</textarea>
                        </div>
                    </div>
                </div>
                <div class="mb-4">
                    ...
                    <div class="grid grid-cols-3 gap-4 mb-4">
                        <div class="relative p-2 bg-gray-100 rounded-lg sm:w-36 sm:h-36 dark:bg-gray-700">
                            ...
                            <img type="file" name="image" src="{{ asset('images/' . $product->product_image) }}" class="w-full mr-2">
                            @else
                ...
                <!-- <div class="flex items-center mb-4">
                    ...
                    <label for="product-options" class="ml-2 text-sm text-gray-500 dark:text-gray-300">
        ...
        <div class="grid grid-cols-2 gap-4 mt-6 sm:w-1/2">
            <button type="submit"
                class="text-blue-600 inline-flex justify-center items-center border-red-600 hover:bg-blue-800 hover:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                Update product
            </button>
            <button type="button"
    ...
    {{-- READ PRODUCT --}}
    @foreach ($products as $product)
    <div id="drawer-read-product-advanced-{{ $product->id }}" class="overflow-y-auto fixed top-0 left-0 z-40 p-4 w-full max-w-lg h-screen bg-white transition-transform -translate-x-full dark:bg-gray-800" tabindex="-1" aria-labelledby="drawer-label-{{ $product->id }}" aria-hidden="true">
        <h4 id="read-drawer-label-{{ $product->id }}" class="mb-1.5 leading-none text-xl font-semibold text-gray-900 dark:text-white">
            {{ $product->product_name }}
        </h4>
        <button type="button" data-drawer-dismiss="drawer-read-product-advanced-{{ $product->id }}" aria-controls="drawer-read-product-advanced-{{ $product->id }}" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 absolute top-2.5 right-2.5 inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white">
            <svg aria-hidden="true" class="w-5 h-5" fill="currentColor" viewbox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                <path fill-rule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clip-rule="evenodd" />
            </svg>
            <span class="sr-only">Close menu</span>
        ...
        <dl class="grid grid-cols-2 gap-4 mb-4">
            <div class="p-3 bg-gray-100 rounded-lg border border-gray-200 dark:bg-gray-700 dark:border-gray-600">
                <dt class="mb-2 font-semibold leading-none text-gray-900 dark:text-white">Product Category</dt>
                <dd class="text-gray-500 dark:text-gray-400">{{ $product->category->category }}</dd>
            </div>
            <div class="p-3 bg-gray-100 rounded-lg border border-gray-200 dark:bg-gray-700 dark:border-gray-600">
                <dt class="mb-2 font-semibold leading-none text-gray-900 dark:text-white">Product Price</dt>
                <dd class="text-gray-500 dark:text-gray-400">{{ $product->product_price }}</dd>
            </div>
            <div class="p-3 bg-gray-100 rounded-lg border border-gray-200 dark:bg-gray-700 dark:border-gray-600">
                <dt class="mb-2 font-semibold leading-none text-gray-900 dark:text-white">Product Stock</dt>
                <dd class="text-gray-500 dark:text-gray-400">{{ $product->product_stock }}</dd>
            </div>
        </dl>
        <div class="flex bottom-0 left-0 justify-center pb-4 space-x-4 w-full">
            <button type="button"
                class="text-white w-full inline-flex items-center justify-center bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
