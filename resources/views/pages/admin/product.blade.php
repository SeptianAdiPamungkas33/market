...
@section('content')
    <div class="container px-6 mx-auto grid">
                    ...
                    <form action="{{ route('add-product-admin') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="grid gap-4 mb-4 sm:grid-cols-2">
                            ...
                            <div class="grid gap-4 sm:col-span-2 md:gap-6 sm:grid-cols-4">
                                <div>
                                    <label for="weight"
                                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">M</label>
                                ...
                                <div>
                                    <label for="length"
                                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">L</label>
                                ...
                                <div>
                                    <label for="breadth"
                                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">XL</label>
                                ...
                                <div>
                                    <label for="width"
                                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">XXL</label>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="flex justify-center items-center w-full">
                                <label for="dropzone-file"
                                    ...
                                    <input id="dropzone-file" type="file" class="hidden" name="image" multiple>
                                </label>
                            </div>
                        </div>
        ...
        <form action="#" id="drawer-update-product"
            ...
            <h5 id="drawer-label"
                class="inline-flex items-center mb-6 text-sm font-semibold text-gray-500 uppercase dark:text-gray-400">Newa
                Product</h5>
            ...
            <div class="grid gap-4 sm:grid-cols-3 sm:gap-6 ">
                ...
                <div class="space-y-4 sm:space-y-6">
                    ...
                    <div>
                        <label for="length"
                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Length (cm)</label>
                    ...
                    <div>
                        <label for="breadth"
                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Breadth (cm)</label>
                        <input type="number" name="breadth" id="breadth"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
